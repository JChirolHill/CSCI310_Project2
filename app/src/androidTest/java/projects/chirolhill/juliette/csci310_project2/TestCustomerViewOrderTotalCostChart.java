...
public class TestCustomerViewOrderTotalCostChart {
    ...
    @Test
    public void testCustomerViewOrderTotalChart() {
        ...
        ViewInteraction appCompatButton4 = onView(
                allOf(withId(R.id.btnDetails), withText("My Orders"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.design.widget.CoordinatorLayout")),
                                        1),
        ...
        onView(withId(R.id.moneyXYPlot)).check(matches(isDisplayed()));
    }
