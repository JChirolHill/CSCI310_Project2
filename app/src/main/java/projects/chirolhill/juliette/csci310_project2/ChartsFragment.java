...
public class ChartsFragment extends Fragment {private String userID;
    private final String TAG = ChartsFragment.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        caffeineBarChart = v.findViewById(R.id.caffeineBarChart);
        moneyXYPlot = v.findViewById(R.id.moneyXYPlot);
